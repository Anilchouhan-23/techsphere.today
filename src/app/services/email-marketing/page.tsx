...
const features = [
  ...
  "A/B Testing for High Conversion",
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="flex-1">
              <span className="inline-block px-4 py-1.5 bg-cyan/10 text-cyan font-semibold text-sm rounded-full mb-4">
                <i className="fas fa-envelope-open-text mr-2" /> Direct Communication
              </span>
              <h2 className="text-3xl md:text-4xl font-bold text-navy mb-6 leading-tight">
                High-Conversion Email Marketing
              </h2>
              <p className="text-gray-600 leading-relaxed mb-6 text-[1.05rem]">
                Email remains one of the highest ROI channels in digital marketing. We design targeted email campaigns that engage your audience, push high-value content, and significantly increase customer retention rates.
              </p>
              <p className="text-gray-600 leading-relaxed mb-8 text-[1.05rem]">
                From automated welcome sequences and abandoned cart recovery to weekly newsletters designed with responsive, modern templates, our email strategies turn casual subscribers into paying customers.
              </p>
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="text-white font-semibold">98% Deliverability</h4>
                        <p className="text-white/70 text-sm">Inbox Guaranteed</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-20 bg-gray-50 border-t border-gray-100">
        <div className="w-[90%] max-w-[1200px] mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-navy mb-4">Email Solutions</h2>
            <p className="text-gray-500 text-lg">Build robust lists and nurture leads with precision targeting.</p>
          </div>
            ...
            {features.map((f, i) => (
              <div key={i} className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div className="w-12 h-12 bg-cyan/10 rounded-xl flex items-center justify-center mb-5">
                  <i className="fas fa-envelope-open-text text-cyan text-xl" />
                </div>
                <h3 className="text-lg font-semibold text-navy mb-2">{f}</h3>
                <p className="text-gray-500 text-sm leading-relaxed">Automated trigger sequences engineered to capture and convert every possible lead.</p>
              </div>
            ))}
          </div>
        </div>
